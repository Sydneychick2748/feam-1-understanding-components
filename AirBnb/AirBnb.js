...
search bar will need all the data and the cards will only need the filtered data 
 ...
 */
// Assuming you have an array of listing objects
// Filter listings that have a pool
// Filter listings that do not have a pool
